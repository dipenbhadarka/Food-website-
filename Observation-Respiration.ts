...
const NON_BASELINE_RESIDENT =
    ...
    process.env.RESPIRATION_NON_BASELINE_RESIDENT ||
...
const selectors = {
    ...
    validationError: locator(
        ...
        '//android.widget.TextView[contains(@text,"Respiration rate should be within the specified range")]',

        '//XCUIElementTypeStaticText[contains(@name,"Respiration rate should be within the specified range")]'

    ),

    lowBaselineGuidance: locator(

        '//android.widget.TextView[contains(@text,"Respiration rate is lower than the specified range")]',

        '//XCUIElementTypeStaticText[contains(@name,"Respiration rate is lower than the specified range")]'

    ),

    highBaselineGuidance: locator(

        '//android.widget.TextView[contains(@text,"Respiration rate is higher than the specified range")]',

        '//XCUIElementTypeStaticText[contains(@name,"Respiration rate is higher than the specified range")]'
