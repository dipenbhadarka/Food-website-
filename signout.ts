...
// (e.g. run right after enrolment.e2e.ts in the
// same session, or the app was left in that state
// manually).
//
...
// ─────────────────────────────────────────────
// Close (X) button — NOT yet confirmed. Trying
// several likely candidates and reporting which
// one (if any) matches.
// ─────────────────────────────────────────────
